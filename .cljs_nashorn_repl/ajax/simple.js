...
ajax.simple.base_handler = (function ajax$simple$base_handler(interceptors,p__46439){
...
var handler = cljs.core.get.call(null,map__46440__$1,new cljs.core.Keyword(null,"handler","handler",-195596612));
...
return cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [response_format], null),(function (){var or__4131__auto__ = p1__46442_SHARP_;
...
ajax.simple.raw_ajax_request = (function ajax$simple$raw_ajax_request(p__46443){
...
var request = map__46444__$1;
var interceptors = cljs.core.get.call(null,map__46444__$1,new cljs.core.Keyword(null,"interceptors","interceptors",-1546782951));
