...
The `home-routes` handler in the `diabetes-dashboard.routes.home` namespace
...
The `home-page` function will in turn call the `diabetes-dashboard.layout/render` function
...
The rest of this page is rendered by ClojureScript found in the `src/cljs/diabetes_dashboard/core.cljs` file.



#### Organizing the routes

The routes are aggregated and wrapped with middleware in the `diabetes-dashboard.handler` namespace:
...
Request middleware functions are located under the `diabetes-dashboard.middleware` namespace.

This namespace is reserved for any custom middleware for the application. Some default middleware is
already defined here. The middleware is assembled in the `wrap-base` function.

Middleware used for development is placed in the `diabetes-dashboard.dev-middleware` namespace found in
